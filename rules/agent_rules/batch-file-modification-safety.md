...
exception_scope: "<INSTALL_DIR>/, <SCRATCH_DIR>/"
---
...
- Target file is **outside** `<INSTALL_DIR>/` and `<SCRATCH_DIR>/`
...
2. Create snapshot: <SCRATCH_DIR>/BEFORE_{yyyy-MM-dd-HHmmss}\
...
```
<SCRATCH_DIR>/BEFORE_2026-06-17-143052\
```
...
✅ RIGHT: Copy to <SCRATCH_DIR>/BEFORE_2026-06-17-143052\ → modify copies → user manually replaces originals
```
