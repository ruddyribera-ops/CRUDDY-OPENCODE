...
```powershell
python "C:\Users\Windows\LasPalmasSchoolBD2026\SIS_MIGRATION_WORKBENCH\scripts\etl_students_v1.py"
```

Run dry-run checks:

```powershell
python "C:\Users\Windows\LasPalmasSchoolBD2026\SIS_MIGRATION_WORKBENCH\scripts\dry_run_checks_v1.py"
```

Run timetable + grades + reconciliation:

```powershell
python "C:\Users\Windows\LasPalmasSchoolBD2026\SIS_MIGRATION_WORKBENCH\scripts\etl_timetable_v1.py"
python "C:\Users\Windows\LasPalmasSchoolBD2026\SIS_MIGRATION_WORKBENCH\scripts\etl_grades_v1.py"
python "C:\Users\Windows\LasPalmasSchoolBD2026\SIS_MIGRATION_WORKBENCH\scripts\reconcile_grade_student_links_v1.py"
python "C:\Users\Windows\LasPalmasSchoolBD2026\SIS_MIGRATION_WORKBENCH\scripts\dry_run_checks_v2.py"
```
