...
| 4 | "Let me just create a new skill" | check if existing skill covers it | Never — directness over speed |
| 5 | "I'll just write minimal docs" | each section: WHAT, WHY, HOW, EXAMPLE | Never — work within role |
