...
| 4 | "Everything is going great" | state specific metrics, blockers, % | Never — directness over speed |
| 5 | "Nothing changed" | list what changed even if small | Never — work within role |
